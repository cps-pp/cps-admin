    ...
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      >
        ...
        <span className="h-12 w-12 rounded-full">
          <img src={Avatar} alt={user?.fullname} className="rounded-full" />
        </span>
      ...
      {dropdownOpen && (
        ...
        >
          <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark list-none">
            <li>
              <Link
                to="/profile"
