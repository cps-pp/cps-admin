  ...
  return (
    <div className="w-full">
      ...
      <div className="relative">
        ...
        <select
          className={`w-full appearance-none rounded py-4 pl-11.5 pr-10 text-black focus-visible:outline-none dark:bg-form-input dark:text-white focus:border-primary disabled:cursor-not-allowed dark:focus:border-primary border ${disabled ? '' : ''} ${className}`}
          id={name}
          name={name}
          value={value}
