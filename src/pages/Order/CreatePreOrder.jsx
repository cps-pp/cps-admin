...
const [supId, setSupId] = useState(null); // แทนที่ ''
  const [suppliers, setSuppliers] = useState([]);
  const [medicines, setMedicines] = useState([]);
  const [loadingSuppliers, setLoadingSuppliers] = useState(true);

  const [details, setDetails] = useState([{ med_id: '', qty: 1 }]);
...
useEffect(() => {
  console.log('supId state changed:', supId);
}, [supId]);
        ...
        <div>
          ...
          <Select
            ...
            optionFilterProp="children"
             onChange={(value) => {
    // console.log('Selected supplier value:', value); //  debug
    setSupId(value);
  }}
         value={supId} 
            className="w-full"
        ...
        <div>
          <label className="block font-semibold mb-2">ລາຍລະອຽດ</label>
            ...
            <div key={index} className="flex gap-4 items-center mb-2">
              <div className="flex-1">
                ...
                <Select
                  ...
                  onChange={(value) =>
                    handleDetailChange(index, 'med_id', value)
                  }
                  className="w-full"
                  optionFilterProp="children"
                  filterOption={(input, option) =>
