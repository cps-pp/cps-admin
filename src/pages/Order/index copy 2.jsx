              ...
              {OrderHeaders.map((header, index) => (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    {header.id === 'id' && (
                      <span
                        className={`ml-1 inline-block text-md font-semibold transition-colors duration-200 ${sortOrder === 'asc' ? 'text-green-500' : 'text-black'
                          }`}
                      >
                        {sortOrder === 'asc' ? '↑' : '↓'}
                      </span>
              ...
              paginatedOrder.map((order, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <span
                      className={`inline-block rounded-full px-3 mt-3 py-1 text-center text-sm font-medium  ${order.status === 'ລໍຖ້າຈັດສົ່ງ'
